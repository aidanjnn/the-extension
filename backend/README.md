...
This backend is the execution layer for Layer. Agentverse handles discovery and chat. FastAPI handles local work: project storage, generated extension files, Manifest V3 validation, ZIP packaging, and load instructions for Chrome.
